class Controller {
     ...
     */
    addItem(title) {
        this.sendAjax("api/todo", Controller.POST, '{"name":"' + title + '", "isComplete":true}', function (event) {
    ...
    editItemSave(id, title) {
        if (title.length) {
            this.sendAjax("api/todo/" + id, Controller.PUT, '{"id":' + id + ', "name":"' + title + '", "isComplete":true}', function (event) {
